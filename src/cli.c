...
static void print_usage(void) {
    ...
    print_markup(
        ...
        "            running source, and fallback is optional for it. Run it with\n"
        "            required information missing at an interactive terminal, and an\n"
        "            interactive wizard fills it in instead of failing.\n"
